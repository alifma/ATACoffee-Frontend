<template>
  <div class="container" style="height:100vh;background:#F2F2F2;">
    ...
    <div class="row px-3" style="height:40vh">
    ...
    <form action="" @submit.prevent="onLogin()" class="px-3 mt-3" style="height:45vh">
      ...
      <p class="text-center mt-3">Don't Have an account? <span class="brown" @click="linkTo('signup')">Sign up</span>
      </p>
    </form>
  </div>
</template>
