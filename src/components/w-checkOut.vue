      ...
      <div class="container">
        <div class="row">
          ...
          <!-- Jika ada itemnya -->
            <div v-for="(item, index) in cart" :key="index" class="row no-gutters" style="height:18vh">
              <div class="col-md-4 text-center my-auto">
                <img :src="`http://52.91.116.102:3001/image/${item.itemImage}`" style="height:100px;width:100px;object-fit:cover;border-radius:25%"
                  class="card-img">
              </div>
              <div class="col-md-8">
                <div class="card-body">
                ...
                <table class="table table-borderless">
                  <tr>
                    <td class="pb-0" style="text-align:left"><p class="mb-0 font-poppins">SUBTOTAL</p></td>
                    <td class="pb-0" style="text-align:right">IDR {{formatPrice(totalPrice)}}</td>
                  </tr>
                  <tr>
                    <td class="pb-0" style="text-align:left"><p class="mb-0 font-poppins">TAX & FEES</p></td>
                    <td class="pb-0" style="text-align:right">IDR {{formatPrice(tax)}}</td>
                  </tr>
                  <tr>
                    <td class="pb-0" style="text-align:left"><p class="mb-0 font-poppins">SHIPPING</p></td>
                    <td class="pb-0" style="text-align:right">IDR {{formatPrice(shipping)}}</td>
                  </tr>
                  <tr>
                    <td class="pb-0" style="text-align:left"><h3 class="font-poppins font-weight-bold" style="color:#362115;">TOTAL</h3></td>
                    <td class="pb-0" style="text-align:right;width:min-content"><h3 class="font-poppins font-weight-bold" style="color:#362115;">IDR {{formatPrice(totalPrice+tax+shipping)}}</h3></td>
                  </tr>
                </table>
              </div>
            </div>
          ...
          <div class="col-5">
            ...
            <button @click="buildFinalData()" class="btn btn-brown w-100 mt-4"  style="font-size:20px;border-radius:25px;height:60px">Confirm and Pay</button>
          </div>
        </div>
      </div>
      </div>
