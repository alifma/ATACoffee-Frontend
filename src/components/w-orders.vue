<template>
  <div style="background-image: url('https://i.ibb.co/xG1TYf0/bg-History.png');background-repeat: no-repeat;background-position: center;">
    <!-- Header -->
    <componentHeader />
    <div v-if="orders.length > 0">
      <div class="container py-4">
        <h1 class="text-white text-center tittle pt-4" style="font-size: 40px;text-shadow: 2px 2px 4px #000000;">Let's see what you have bought!</h1>
      </div>
            ...
            <div class="row w-100">
              ...
              <div class="col-4 d-flex justify-content-center">
                ...
                <p v-for="(index, page) in pagination.totalPages" :key="index" class="mb-0 btn btn-warning mx-2"
                  @click="getOrderLimitQuery(page+1)">{{page+1}}</p>
              </div>
              <div class="col-2">
